...
class SCNProgramViewController: UIViewController, ARSCNViewDelegate {
  ...
  func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
    ...
    if let material = faceGeometry.firstMaterial {
      ...
      program.vertexFunctionName = "vertexShaderSCNProgram"
      program.fragmentFunctionName = "fragmentShaderSCNProgram"
